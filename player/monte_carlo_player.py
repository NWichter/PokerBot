...
# dieser Algorithmus verwendet einen Monte Carlo Algorithmus, um seine Siegesrate zu berechnen. Abhängig davon führt er unterschiedliche Aktionen aus.


# Function for the calculation of the winrate
